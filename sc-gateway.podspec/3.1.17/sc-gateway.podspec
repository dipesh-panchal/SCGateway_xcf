...
Pod::Spec.new do |spec|
  ...
  spec.ios.vendored_framework = 'SCGateway.xcframework'
  spec.source ={ :http => "https://github.com/dipesh-panchal/SCGateway_xcf/raw/main/SCGateway.xcframework.zip"}
